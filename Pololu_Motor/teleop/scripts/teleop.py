...
class Motor_Controller():
    def __init__(self):
        ...
        self.motor_pub = rospy.Publisher('pololu/command', Float64MultiArray, queue_size=1)
    ...
    def single_motor(self, motor, intensity):
        print motor
        print intensity
        arr = [1500,1500,1500,1500,1500,1500,1500,1500]
        i = int(motor_kybrd[motor])
        arr[i] = int(intensity)*10 + 1500
        self.motor_cmd.data = arr
