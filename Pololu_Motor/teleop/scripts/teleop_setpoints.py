...
class Motor_Controller():
    def __init__(self):
        ...
        self.yaw_setpoint_pub = rospy.Publisher('/yaw_PID/setpoint',Float64,queue_size=1)
        self.yaw_setpoint_pub_data = Float64()
        self.roll_setpoint_pub = rospy.Publisher('/roll_PID/setpoint',Float64,queue_size=1)
        self.roll_setpoint_pub_data = Float64()
        self.pitch_setpoint_pub = rospy.Publisher('/pitch_PID/setpoint',Float64,queue_size=1)
        self.pitch_setpoint_pub_data = Float64()
        self.depth_setpoint_pub = rospy.Publisher('/depth_PID/setpoint',Float64,queue_size=1)
        self.depth_setpoint_pub_data = Float64()
        self.drive_setpoint_pub = rospy.Publisher('/drive_PID/setpoint',Float64,queue_size=1)
        self.drive_setpoint_pub_data = Float64()
        self.strafe_setpoint_pub = rospy.Publisher('/strafe_PID/setpoint',Float64,queue_size=1)
