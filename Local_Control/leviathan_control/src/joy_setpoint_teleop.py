...
def joy_teleop():
    ...
    pub_yaw = rospy.Publisher('/local_control/pid/yaw/setpoint', Float64, queue_size=10)
    pub_drive = rospy.Publisher('/local_control/pid/drive/setpoint', Float64, queue_size=10)
    pub_strafe = rospy.Publisher('/local_control/pid/strafe/setpoint', Float64, queue_size=10)
