...
class PID_Pololu():
    ...
    def __init__(self):
        ...
        self.motor_array[6] = [ 0,  0,  0.2,   0, -.7,  0] #Left -.65
        ...
        self.yaw_sub = rospy.Subscriber('/local_control/pid/yaw/control_effort',
                                        Float64, self.yaw_callback)
        ## Subscriber for the depth pid topic
        self.depth_sub = rospy.Subscriber('/local_control/pid/depth/control_effort',
                                          Float64, self.depth_callback)
        ## Subscriber for the drive pid topic
        self.drive_sub = rospy.Subscriber('/local_control/pid/drive/control_effort',
                                          Float64, self.drive_callback)
        ## Subscriber for the strafe pid topic
        self.strafe_sub = rospy.Subscriber('/local_control/pid/strafe/control_effort',
